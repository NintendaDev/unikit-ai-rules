...
Live-ops is a feedback system — each event teaches the next:

- Per-event metrics: participation, completion, retention lift, revenue, and
...
- Measuring events by revenue alone, ignoring sentiment and goodwill.
